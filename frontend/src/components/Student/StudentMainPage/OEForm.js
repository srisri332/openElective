          ...
          onClick={() => {
            ...
            if (isValid === true && choices.length > 0) {
              ...
              choices.forEach((choice) => {
                ...
                axios
                  .post(
                    "https://openelectiveapi.azurewebsites.net/api/StudentChoice",
                    choice,
                    config
                  )
                  .then((res) => {
            ...
            let rollNumber = localStorage.getItem("studentRoll");
            api.put("/api/Student/elected/" + rollNumber).then((res) => {
              console.log(res.data);
            });
          }}>
          Submit
